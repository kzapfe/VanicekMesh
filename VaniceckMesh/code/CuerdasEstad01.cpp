...
int main(int argc, char *argv[]){
  ...
  const int PuntosDominioEje=1002;
  ...
  */
  ...
  double CuerdaEnDosXhiReal=0;
  double CuerdaEnDosXhiImag=0;
  ...
  for(int j=-PuntosDominioMu; j<PuntosDominioMu; j++){
	...
	//indice de las muq 
      ...
      CuerdaEnDosXhiReal=0;
      CuerdaEnDosXhiImag=0;
	...
	CuerdaEnDosXhiReal+=auxiliarresult*cos(exponente);
	CuerdaEnDosXhiImag+=auxiliarresult*sin(exponente);
	  ...
	  <<CuerdaEnDosXhiReal<<"\t"<<CuerdaEnDosXhiImag<<endl;     
